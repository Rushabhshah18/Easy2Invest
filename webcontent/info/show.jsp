						...
						<div class="toolbar row">
							<div class="col-sm-6 hidden-xs">
								<div class="page-header">
									<h1>Entreprenures <small>People With IDeas</small></h1>
								</div>
							</div>
							...
							<div class="col-md-12">
								...
								<tbody>
									...
									<tr>
										...
										<%if(differentUser.equals("admin") || differentUser.equals("Admin") ){ %>
										<td><a
											href="<%=request.getContextPath()%>/Store?actionCode=doUpdateUser&&id=<%=entreprenure.getId()%>"class="btn btn-light-blue tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a></td>
										<td><a
											href="<%=request.getContextPath()%>/Store?actionCode=doDeleteUser&&id=<%=entreprenure.getId()%>" class="btn btn-red tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a></td>
										<%-- <td><a id="successSweetAlert"
														class="btn btn-primary pull-right"
														href="<%=request.getContextPath()%>/Store?actionCode=doSendMail&&email=<%=entreprenure.getEmail()%>&&id=<%=entreprenure.getId()%>&&differentUser=<%=differentUser%>&&currentSessionEmail=<%=currentSessionEmail%>">
															Send Mail </a></td> --%>
															<%} %>
									</tr>
									<%
