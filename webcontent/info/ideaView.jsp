					...
					<div class="toolbar row">
						<div class="col-sm-6 hidden-xs">
							<div class="page-header">
								<h1>
									Idea <small>brainstorming Ideas of People</small>
								</h1>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb">
								...
								<li class="active">User's Idea</li>
							</ol>
						</div>
					</div>
					<!-- end: BREADCRUMB -->
										...
										<table
											...
											<thead>
												<tr>
													...
													<th class="hidden-xs">Send Proposal</th>
												...
												<tr>
													...
													<td><a
														...
														data-original-title="Remove"><i
															...
															<%} %>
<td><%=idea.getAmount()%></td><td><a id="successSweetAlert"
														class="btn btn-primary pull-right"
														href="<%=request.getContextPath()%>/Idea?actionCode=doSendMail&&email=<%=idea.getEmail()%>&&id=<%=idea.getId()%>&&differentUser=<%=differentUser%>&&currentSessionEmail=<%=currentSessionEmail%>">
															Send Mail </a></td>
														<td><a id="successSweetAlert"
														class="btn btn-primary pull-right"
														href="<%=request.getContextPath()%>/webcontent/info/proposal.jsp?email=<%=idea.getEmail()%>&&currentSessionEmail=<%=currentSessionEmail%>">
															Send Proposal </a></td>
