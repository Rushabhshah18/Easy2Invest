...
<!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
		<link rel="stylesheet" href="<%= request.getContextPath()%>/front/plugins/weather-icons/css/weather-icons.min.css">
		<link rel="stylesheet" href="<%= request.getContextPath()%>/front/plugins/nvd3/nv.d3.min.css">
										...
										<div class="e-slider owl-carousel owl-theme">
											<div class="item">
												...
												<div class="panel-footer">
													<div class="avatar-note"><img src="<%= request.getContextPath()%>/front/images/avatar-2-small.jpg" alt="">
													</div>
											...
											<div class="item">
												...
												<div class="panel-footer">
													...
													<div class="avatar-note"><img src="<%= request.getContextPath()%>/front/images/avatar-3-small.jpg" alt="">
													</div>
											...
											<div class="item">
												...
												<div class="panel-footer">
													...
													<div class="avatar-note"><img src="<%= request.getContextPath()%>/front/images/avatar-4-small.jpg" alt="">
													</div>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-12">
								<div class="panel panel-white">
									...
									<div class="panel-body no-padding">
										<div class="padding-10">
											<img width="50" height="50" alt="" class="img-circle pull-left" src="<%= request.getContextPath()%>/front/images/avatar-1-big.jpg">
												...
												<div id="users_tab_example1" class="tab-pane padding-bottom-5 active">
													<div class="panel-scroll height-230">
														<table class="table table-striped table-hover">
															<tbody>
																<tr>
																	<td class="center"><img src="<%= request.getContextPath()%>/front/images/avatar-1.jpg" class="img-circle" alt="image"/></td>
																...
																<tr>
																	<td class="center"><img src="<%= request.getContextPath()%>/front/images/avatar-2.jpg" class="img-circle" alt="image"/></td>
																...
																<tr>
																	<td class="center"><img src="<%= request.getContextPath()%>/front/images/avatar-3.jpg" class="img-circle" alt="image"/></td>
																...
																<tr>
																	<td class="center"><img src="<%= request.getContextPath()%>/front/images/avatar-5.jpg" class="img-circle" alt="image"/></td>
																...
																<tr>
																	<td class="center"><img src="<%= request.getContextPath()%>/front/images/avatar-4.jpg" class="img-circle" alt="image"/></td>
									...
									<div class="panel-body panel-portfolio no-padding">
										<div class="portfolio-grid portfolio-hover">
											...
											<div class="e-slider owl-carousel owl-theme portfolio-grid portfolio-hover" data-plugin-options='{"pagination": false, "stopOnHover": true}'>
												<div class="item">
													<img src="<%= request.getContextPath()%>/front/images/image01.jpg" alt="">
													<div class="caption">
												...
												<div class="item">
													<img src="<%= request.getContextPath()%>/front/images/image02.jpg" alt="">
													<div class="caption">
														<h2 class="caption-title">Hover Style #10</h2>
														<p class="caption-description">
															A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.
												...
												<div class="item">
													<img src="<%= request.getContextPath()%>/front/images/image03.jpg" alt="">
													<div class="caption">
														<h2 class="caption-title">Hover Style #10</h2>
														<p class="caption-description">
															A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.
												...
												<div class="item">
													<img src="<%= request.getContextPath()%>/front/images/image04.jpg" alt="">
													<div class="caption">
														<h2 class="caption-title">Hover Style #10</h2>
														<p class="caption-description">
															A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.
				...
				<div class="panel panel-note">
					<div class="e-slider owl-carousel owl-theme">
						<div class="item">
							...
							<div class="panel-footer">
								<div class="avatar-note">
									<img src="<%= request.getContextPath()%>/front/images/avatar-2-small.jpg" alt="">
								</div>
						...
						<div class="item">
							...
							<div class="panel-footer">
								<div class="avatar-note">
									<img src="<%= request.getContextPath()%>/front/images/avatar-3-small.jpg" alt="">
								</div>
						...
						<div class="item">
							...
							<div class="panel-footer">
								<div class="avatar-note">
									<img src="<%= request.getContextPath()%>/front/images/avatar-4-small.jpg" alt="">
								</div>
...
<%  System.out.println("in if"+userName+password);}else{
