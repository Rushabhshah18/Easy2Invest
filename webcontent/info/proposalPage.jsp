<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%!
    String currentSessionMailId;
    String proposalSendingMailId;
    %>
    <%
    	...
    	}if(!(request.getParameter("currentSessionEmail")).isEmpty()){
   		 currentSessionMailId=request.getParameter("currentSessionEmail");
    		System.out.println(currentSessionMailId);
    	}
    	if(!(request.getParameter("email")).isEmpty()){
    		 proposalSendingMailId=request.getParameter("email");
    		System.out.println(proposalSendingMailId);
    	}
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white side">
									...
									<div class="panel-body">
										<h2><i class="fa fa-pencil-square"></i> PROPOSAL</h2>
										<p>
											Create one account to manage everything you do with Rapido, from your shopping preferences to your Rapido activity.
										</p>
										<hr>			
										<form action="<%=request.getContextPath()%>/proposal" role="form" id="form">
										 <%
									String error="Go";
										 System.out.println("Proposal page");
									if((session.getAttribute("errorProposal")).equals(null)){
										System.out.println("Null");
									};
									if(!(session.getAttribute("errorProposal")).equals(null)){
									error=(String)session.getAttribute("errorProposal");
									System.out.println(error);
									}
									if(error.contains("Success")){
										%><div class="alert alert-success">Success</div><% session.setAttribute("errorProposal", "Go");
									}if(error.contains("Failed")){
										%><div class="alert alert-danger">Failed</div><%session.setAttribute("errorProposal", "Go");
									 ...
									 %>  
											<div class="row">
												...
												<%if(currentSessionMailId.isEmpty() && proposalSendingMailId.isEmpty()){ %>
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">
															Sender Name <span class="symbol required"></span>
														</label>
														<input class="form-control tooltips" type="text" data-original-title="Insert your name here" data-rel="tooltip"  title="" data-placement="top" name="sendername" id="sender">
														<div class="form-group">
															<label class="control-label" style="padding-top:2%;">
																Receiver Name <span class="symbol required"></span>
															</label>
															<input class="form-control tooltips" type="text" data-original-title="Insert your name here" data-rel="tooltip"  title="" data-placement="top" name="receivername" id="receiver">
														</div>
													</div>
												</div><%} %>
												<%
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input class="form-control tooltips" type="text" data-original-title="Insert your name here" data-rel="tooltip"  title="" data-placement="top" name="sendername" id="sender" value="<%=proposalSendingMailId%>">
														<div class="form-group" >
															<label class="control-label" style="padding-top:2%;">
																Receiver Name <span class="symbol required"></span>
															</label>
															<input class="form-control tooltips" type="text" data-original-title="Insert your name here" data-rel="tooltip"  title="" data-placement="top" name="receivername" id="receiver" value="<%=currentSessionMailId%>">
														</div>
													</div>
												</div><%} %>
												...
												<div class="form-group">
																...
																<input class="form-control tooltips" type="text" data-original-title="Enter Your City" data-rel="tooltip"  title="" data-placement="top" name="city" id="city">
															</div>
													...
													<div class="form-group">
														...
														<input type="email" placeholder="Text Field"  data-original-title="Enter your Email" class="form-control" id="email" name="email">
													</div>
												</div>
												<div class="col-md-6">
												<div class="form-group">
																...
																<input class="form-control tooltips" type="number" data-original-title="Amount you need to insert" data-rel="tooltip"  title="" data-placement="top" name="amount" id="amount">
															</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="form-group">
																<label class="control-label">
																	Proposal Idea<span class="symbol required"></span><br>
																</label><br>
																	 <textarea cols="70" rows="10" placeholder="Enter Your Future" data-original-title="Enter your Thoghts" border="3" name="proposal" id="proposal"></textarea>
	 														</div>
														</div>
													</div>
											</div>
											...
											<div class="row">
												<div class="col-md-8">
													<p>
														By clicking SEND, you are agreeing to the Policy and Terms &amp; Conditions.
													</p>
												</div>
												<div class="col-md-4 down">
												<input type="hidden" name="actionCode" value="doAddProposal">
