					...
					<div class="panel panel-white side">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label"> Entreprenure Name <span
												...
												name="entreprenureName" id="sender" >
											<div class="form-group">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea cols="70" rows="10" placeholder="Enter Your Future"
												...
												name="idea" id="proposal" ></textarea>
										</div>
									</div>
								</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-4 down">
								<input type="hidden" name="actionCode" value="doAddIdea">
