...
<body>
					...
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb">
								...
								<li class="active">Proposals Data</li>
							</ol>
						</div>
					</div>
					<!-- end: BREADCRUMB -->
									...
									<div class="table-responsive">
										<table
											...
											System.out.println(value);
																														List<proposal> list_proposal=(List<proposal>)(session.getAttribute("list_proposal"));
																												if(!list_proposal.isEmpty() && list_proposal!=null){
																																																								Iterator it=list_proposal.iterator();
											...
											<tbody>
												...
												<tr>
													...
													<td><a id="successSweetAlert"
															...
															href="<%=request.getContextPath()%>/proposal?actionCode=doSendMail&&email=<%=proposal.getEmail()%>&&id=<%=proposal.getId()%>&&differentUser=<%=differentUser%>&&currentSessionEmail=<%=currentSessionEmail%>">
																Send Mail </a></td>
													<%
														if(differentUser.equals("admin") || differentUser.equals("Admin") ){
													%>
	...
	<script
		src="<%=request.getContextPath()%>/front/js/ui-notifications.js"></script>
	<script
		src="<%=request.getContextPath()%>/front/plugins/sweetalert/lib/sweet-alert.min.js"></script>
