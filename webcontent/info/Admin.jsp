						...
						<fieldset>
							...
							<div class="form-group">
								<div>
									...
									<input type="radio" value="Admin" name="user" class="square-black"    style="position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;">
