...
<div class="main-container inner">
						...
						<div class="toolbar row">
							<div class="col-sm-6 hidden-xs">
								<div class="page-header">
									<h1>FAQs <small>Manage Faqs</small></h1>
								</div>
							</div>
							...
							<div class="col-md-12">
								...
								<thead>
									<tr>
										...
										<th>Created_date</th>
										<th class="hidden-xs">Send Mail</th>
								...
								System.out.println(currentSessionEmail);
									List<entreprenure> list_entreprenure=(List<entreprenure>)(session.getAttribute("list_entreprenure"));
																			if(!list_entreprenure.isEmpty() && list_entreprenure!=null){
																				Iterator it=list_entreprenure.iterator();
																				entreprenure entreprenure=null;
																				
																				while(it.hasNext()){
																					entreprenure=(entreprenure)it.next();
								%>
								<tbody>


									<tr>
										<td><%=entreprenure.getId()%></td>
										<td class="hidden-xs"><%=entreprenure.getfirstname()%></td>
										<td><%=entreprenure.getLastname()%></td>
										<td class="hidden-xs"><%=entreprenure.getEmail()%></td>
										
										<td class="hidden-xs"><%=entreprenure.getGender()%></td>
										<td><%=entreprenure.getBirthdate()%></td>
										<td class="hidden-xs"><%=entreprenure.getAddress()%></td>
										<td><%=entreprenure.getCreated_date()%></td>
										<td><a id="successSweetAlert"
														class="btn btn-primary pull-right"
														href="<%=request.getContextPath()%>/Idea?actionCode=doSendMail&&email=<%=entreprenure.getEmail()%>&&id=<%=entreprenure.getId()%>&&differentUser=<%=differentUser%>&&currentSessionEmail=<%=currentSessionEmail%>">
															Send Mail </a></td>
										<%if(differentUser.equals("admin") || differentUser.equals("Admin") ){ %>
										<td><a
											href="<%=request.getContextPath()%>/Idea?actionCode=doUpdateUser&&id=<%=entreprenure.getId()%>" class="btn btn-light-blue tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a></td>
										<td><a
											href="<%=request.getContextPath()%>/Idea?actionCode=doDeleteUser&&id=<%=entreprenure.getId()%>" class="btn btn-red tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a></td>
	...
	<script
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/front/plugins/select2/select2.min.js"></script>
		<script src="<%=request.getContextPath()%>/front/plugins/tableExport/tableExport.js"></script>
		<script src="<%=request.getContextPath()%>/front/plugins/tableExport/jquery.base64.js"></script>
		<script src="<%=request.getContextPath()%>/front/plugins/tableExport/html2canvas.js"></script>
		<script src="<%=request.getContextPath()%>/front/plugins/tableExport/jquery.base64.js"></script>
		<script src="<%=request.getContextPath()%>/front/plugins/tableExport/jspdf/libs/sprintf.js"></script>
		<script src="<%=request.getContextPath()%>/front/plugins/tableExport/jspdf/jspdf.js"></script>
		<script src="<%=request.getContextPath()%>/front/plugins/tableExport/jspdf/libs/base64.js"></script>
