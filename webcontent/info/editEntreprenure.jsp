...
<%
    ...
    %>
<%
	List<entreprenure> list_Entreprenure = (List<entreprenure>) session
			.getAttribute("entreprenure");
%>
<%!int id;
	String name;
	String email;
					...
					<div class="toolbar row">
						<div class="col-sm-6 hidden-xs">
							<div class="page-header">
								<h1>
									User Management <small>Edit Entreprenure</small>
								</h1>
							</div>
						</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb" style="margin-left:25px;">
								...
								<li class="active">Edit Entreprenure</li>
							</ol>
						</div>
					</div>
					<!-- end: BREADCRUMB -->
							...
							<div class="panel panel-white" style="margin-left:25px;margin-top:25px;padding-left:10px">
								<div class="panel-heading">
									<h4 class="panel-title">
										Edit <span class="text-bold">Entreprenure</span>
									</h4>
								</div>
								<div class="panel-body">
									...
									<p>Edit an Entreprenure details</p>
									<hr>
									<form action="<%=request.getContextPath()%>/Store" role="form" id="form" method="post">
										<div class="row">
											<div class="col-md-12">
