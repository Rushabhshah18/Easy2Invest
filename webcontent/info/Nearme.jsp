					...
					<div class="container">
						...
						<div class="toolbar row" style="width:100%;">
							<div class="" style="width:100%;margin-left:1%;">
								<div class="page-header">
									<h1>NEAR Investors <small>This tab provides investors near you </small></h1>
						...
						<%String currentSessionEmail=(String)session.getAttribute("email");
								System.out.println(currentSessionEmail);
									List<investor> list_investor=(List<investor>)(session.getAttribute("listOfSPecificUsersNearMe"));
